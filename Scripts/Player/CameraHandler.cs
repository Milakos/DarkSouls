...
namespace SG
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        public void HandleCameraRitation(float delta, float mouseXInput, float mouseYInput)
        {
        ...
        private void HandleCameraCollision(float delta)
        {
            ...
            if(Physics.SphereCast(cameraTransform.position, cameraShpereRadius, direction, out hit, Mathf.Abs(targetPosition), ignoreLayers))
            {
