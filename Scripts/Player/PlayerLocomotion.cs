...
namespace SG
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        LayerMask ignoreForGroudndCheck;
        ...
        void Start()
        {
            ...
            animatorHandler.Intitialize();

            playerManager.isGrounded = true;
            ignoreForGroudndCheck = ~(1 << 8 | 1 << 11);
        }
        ...
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            if (Physics.Raycast(origin, -Vector3.up, out hit, minimumDistanceNeededToBeginFall, ignoreForGroudndCheck))
            {
           ...
           // if (playerManager.isInteracting)
            ...
            if (inputHandler.jump_input && playerManager.isGrounded)
            {
                if (inputHandler.moveAmount >= 0)
                {
                    ...
                    moveDirection.z = jumpingVelocity;
